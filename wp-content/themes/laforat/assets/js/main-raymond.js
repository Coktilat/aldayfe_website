...
(function($) {
	...
	var laforatObj = {
		...
		jws_theme_set_stick_bar:function( header_offset ){
			laforatObj._header_offset = ( header_offset ) ? header_offset : ( ( laforatObj._header_offset ) ? laforatObj._header_offset : ( $('.tb-header-wrap .tb-header-menu').length > 0 ) ? $('.tb-header-wrap .tb-header-menu').offset() : 0 );
			if( laforatObj._header_offset ){
				if ($(window).scrollTop() > laforatObj._header_offset.top) {
		...
		jws_theme_run_ready:function(){
			...
			laforatObj.jws_theme_carousel( 4,'.tb-product-carousel' );
