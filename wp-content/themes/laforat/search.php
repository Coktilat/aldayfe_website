		...
		<div class="container">
			<div class="row">
				...
				<div class="<?php echo esc_attr($cl_content) ?> content">
					...
					if( have_posts() ) {
						$loop = 0;
						$columns = isset($jws_theme_options['jws_theme_blog_column']) ? (empty($jws_theme_options['jws_theme_blog_column']) ? 1 : $jws_theme_options['jws_theme_blog_column']) : 1;
						...
						while ( have_posts() ) : the_post();
							...
							echo '<div class="'.$class_columns.' tb-blog-grid">';
