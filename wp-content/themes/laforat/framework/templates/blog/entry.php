...
if(is_home()){
	...
	$jws_theme_blog_post_excerpt_more = isset($jws_theme_options['jws_theme_options[jws_theme_blog_post_excerpt_more]']) ? $jws_theme_options['jws_theme_options[jws_theme_blog_post_excerpt_more]'] : __('Read More','laforat');
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="tb-post-item">
	    <?php if (has_post_thumbnail()) { ?>
	        <div class="tb-thumb">
	            <!-- Get Thumb -->
	            <?php the_post_thumbnail('laforat-blog-large-hard-crop', array('class'=>'img-responsive')); ?>
		...
		<div class="tb-content">
			...
			<?php } ?>
			<?php if($jws_theme_show_post_title) { ?>
