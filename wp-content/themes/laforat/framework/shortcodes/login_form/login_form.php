...
function jws_theme_login_form_func($atts, $content = null) {
    ...
    ?>
		<div class="<?php echo esc_attr(implode(' ', $class)); ?>">
			<h5 class="tb-title"><?php _e('Login', 'laforat'); ?></h5>
			<p><?php _e('Hello, Welcome your to account', 'laforat'); ?></p>
			<div class="tb-social-login">
				<a class="tb-facebook-login" href="<?php echo esc_url($link_facebook); ?>"><i class="fa fa-facebook"></i><?php _e('Sign In With Facebook', 'laforat') ?></a>
				<a class="tb-twitter-login" href="<?php echo esc_url($link_twitter); ?>"><i class="fa fa-twitter"></i><?php _e('Sign In With Twitter', 'laforat') ?></a>
			</div>
			<?php
				$args = array(
					'echo'           => true,
					...
					'id_submit'      => 'wp-submit',
					'label_username' => __( 'Email Address', 'laforat' ),
					'label_password' => __( 'Password', 'laforat' ),
					'label_remember' => __( 'Remember me!', 'laforat' ),
					'label_log_in'   => __( 'LogIn', 'laforat' ),
					'value_username' => '',
