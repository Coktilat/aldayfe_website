...
function jws_theme_list_team_func($atts, $content = null) {
    ...
    $class = array();
    $class[] = 'tb-testimonial-slider tb-flex-slider';
    $class[] = $el_class;
	...
	<div class="<?php echo esc_attr(implode(' ', $class)); ?>">
		<div class="row">
			<?php while ( $wp_query->have_posts() ) { $wp_query->the_post(); ?>
				<div class="col-sm-6 col-md-<?php echo intval( 12/$posts_per_page );?>">
                    ...
                    <?php } ?>
                    <?php if( $show_social ):
                        $social = apply_filters( 'the_content', get_post_meta( get_the_ID(), 'jws_theme_team_social', true ) );
                        if( ! empty( $social ) ):
                     ?>
                        <div class="tb-social">
                            <?php echo $social; ?>
