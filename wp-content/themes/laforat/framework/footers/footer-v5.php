	...
	if( $jws_theme_display_footer ){
	 ...
	 ?>
	<div class="jws_theme_footer tb-footer-v5 <?php if( $jws_theme_footer_full ) echo 'tb-layout-fullwidth ';if(jws_theme_get_object_id('jws_theme_footer')) echo jws_theme_get_object_id('jws_theme_footer'); ?>">
		<?php if( is_active_sidebar('tbtheme-before-footer-1') || is_active_sidebar('tbtheme-before-footer-2') ): ?>
		<div class="footer-header">
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 jws_theme_before_footer_1">
						<?php if(is_active_sidebar('tbtheme-before-footer-4')){ dynamic_sidebar("tbtheme-before-footer-4"); } ?>
					</div>
					<div class="col-xs-12 col-sm-12 col-md-12 jws_theme_before_footer_5">
						<?php if(is_active_sidebar('tbtheme-before-footer-5')){ dynamic_sidebar("tbtheme-before-footer-5");} ?>
					</div>
		...
		<div class="footer-top">
			<div class="container">
				<div class="row same-height">
					<div class="col-xs-6 col-sm-2 col-md-2 jws_theme_footer_top_one">
						<?php if(is_active_sidebar('tbtheme-footer-top-2')){ dynamic_sidebar("tbtheme-footer-top-2"); } ?>
					</div>
					<div class="col-xs-6 col-sm-2 col-md-2 jws_theme_footer_top_two">
						<?php if(is_active_sidebar('tbtheme-footer-top-4')){ dynamic_sidebar("tbtheme-footer-top-4"); }?>
					</div>
					<div class="col-xs-6 col-sm-2 col-md-2 jws_theme_footer_top_three">
						<?php if(is_active_sidebar('tbtheme-footer-top-3')){ dynamic_sidebar("tbtheme-footer-top-3"); }?>
					</div>
					<div class="col-xs-6 col-sm-2 col-md-2 jws_theme_footer_top_four">
						<?php if(is_active_sidebar('tbtheme-footer-top-9')){ dynamic_sidebar("tbtheme-footer-top-9"); }?>
					</div>
					<div class="col-xs-6 col-sm-2 col-md-2 jws_theme_footer_top_eight">
						<?php if(is_active_sidebar('tbtheme-footer-top-8')){ dynamic_sidebar("tbtheme-footer-top-8"); }?>
					</div>
					<div class="col-xs-6 col-sm-2 col-md-2 jws_theme_footer_top_eight_hide">
						<?php if(is_active_sidebar('tbtheme-footer-top-8')){ dynamic_sidebar("tbtheme-footer-top-8"); }?>
					</div>
				</div>
			</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-6 jws_theme_before_footer_2">
