		...
		<div class="footer-header">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-5 jws_theme_before_footer_2">
						<?php if(is_active_sidebar('tbtheme-before-footer-3')){ dynamic_sidebar("tbtheme-before-footer-3");} ?>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-4 jws_theme_before_footer_3">
		...
		<div class="footer-top">
			<div class="container">
				<div class="row same-height">
					<div class="col-xs-12 col-sm-6 col-md-2 jws_theme_footer_top_one">
						<?php if(is_active_sidebar('tbtheme-footer-top-2')){ dynamic_sidebar("tbtheme-footer-top-2"); } ?>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-2 jws_theme_footer_top_two">
					...
					<div class="col-xs-12 col-sm-6 col-md-4 jws_theme_footer_top_four">
