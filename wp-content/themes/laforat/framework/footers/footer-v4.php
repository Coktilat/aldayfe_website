	...
	if( $jws_theme_display_footer ){
	 ...
	 ?>
	<div class="jws_theme_footer tb-footer-v4 <?php if( $jws_theme_footer_full ) echo 'tb-layout-fullwidth ';if(jws_theme_get_object_id('jws_theme_footer')) echo jws_theme_get_object_id('jws_theme_footer'); ?>">
