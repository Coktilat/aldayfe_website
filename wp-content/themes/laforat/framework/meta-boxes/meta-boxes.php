...
class jws_theme_FrameworkMetaboxes {
	...
	public function add_meta_boxes()
	{
		...
		$this->add_meta_box('post_options', __('Page Options','laforat'), 'page');
		$this->add_meta_box('product_options', __('Product Options','laforat'), 'product');
		$this->add_meta_box('post_video', __('Video Settings','laforat'), 'post');
		$this->add_meta_box('post_audio', __('Audio Settings','laforat'), 'post');
		$this->add_meta_box('post_quote', __('Quote Settings','laforat'), 'post');
		$this->add_meta_box('post_link', __('Link Settings','laforat'), 'post');
		$this->add_meta_box('post_testimonial', __('Testimonial Settings','laforat'), 'testimonial');
		$this->add_meta_box('post_portfolio', __('Portfolio Settings','laforat'), 'portfolio');
		$this->add_meta_box('post_team', __('Team Settings','laforat'), 'team');
	}
