        ...
        "params" => array(
			array(
                ...
                "value" => array(
					...
					__("Template 2 (Medium thumb)",'laforat') => "tpl2",
                    __("Template 3 (Medium thumb with first big item see 'Weekly Featured')",'laforat') => "tpl3",
					__("Template 4 (Small thumb with one columns)",'laforat') => "tpl4"
                ),
			...
			array(
                "type" => "textfield",
                "class" => "",
                "heading" => __("Title Load", 'laforat'),
                "param_name" => "title_load",
                "value" => "",
				"description" => __( "please enter the text from the keyboard.", 'laforat' )
            ),
            array(
                "type" => "checkbox",
                "heading" => __('Show View More', 'laforat'),
            ...
            array(
                ...
                "group" => __("Template", 'laforat'),
                "description" => __('Show or hide pagination in this element.', 'laforat')
            ),
            array(
                "type" => "dropdown",
                "class" => "",
                "heading" => __("Align Pagination", 'laforat'),
                "param_name" => "el_align",
                "value" => array(
