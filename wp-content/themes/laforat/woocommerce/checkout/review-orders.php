...
<div class="ro-checkout-summary">
	<div class="ro-title">
	  <h4><?php _e('Order Summary','laforat');?></h4>
	</div>
	<div class="ro-body">
		<?php
	...
	<div class="ro-footer">
		...
		<?php if ( WC()->cart->needs_shipping() && WC()->cart->show_shipping() ) : ?>
			...
			<div class="shipping">
				<p>
					<?php
						if ( isset($show_package_details) && $show_package_details ) {
					...
					<div class="ro-shipping-method">
						<?php if ( ! empty( $available_methods ) ) : ?>
							...
							<?php if ( 1 === count( $available_methods ) ) :
								...
								<input type="hidden" name="shipping_method[<?php echo $index; ?>]" data-index="<?php echo $index; ?>" id="shipping_method_<?php echo $index; ?>" value="<?php echo esc_attr( $method->get_id() ); ?>" class="shipping_method" />

							<?php elseif ( get_option( 'woocommerce_shipping_method_format' ) === 'select' ) : ?>

								<select name="shipping_method[<?php echo $index; ?>]" data-index="<?php echo $index; ?>" id="shipping_method_<?php echo $index; ?>" class="shipping_method">
									<?php foreach ( $available_methods as $method ) : ?>
										<option value="<?php echo esc_attr( $method->get_id() ); ?>" <?php selected( $method->get_id(), $chosen_method ); ?>><?php echo wp_kses_post( wc_cart_totals_shipping_method_label( $method ) ); ?></option>
									<?php endforeach; ?>
								</select>
							...
							<?php else : ?>
								<ul id="shipping_method">
									<?php foreach ( $available_methods as $method ) : ?>
										<li>
											<input type="radio" name="shipping_method[<?php echo $index; ?>]" data-index="<?php echo $index; ?>" id="shipping_method_<?php echo $index; ?>_<?php echo sanitize_title( $method->get_id() ); ?>" value="<?php echo esc_attr( $method->get_id() ); ?>" <?php checked( $method->get_id(), $chosen_method ); ?> class="shipping_method" />
											<label for="shipping_method_<?php echo $index; ?>_<?php echo sanitize_title( $method->get_id() ); ?>"><?php echo wp_kses_post( wc_cart_totals_shipping_method_label( $method ) ); ?></label>
										</li>
									<?php endforeach; ?>
								</ul>
						...
						<?php if ( isset($show_package_details) &&  $show_package_details ) : ?>
							<?php
