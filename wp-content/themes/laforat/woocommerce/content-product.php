...
<?php
	if($woocommerce_loop['columns'] == 5){
		...
		$woo_columns = "tb-products-grid tb-woo-two-column col-lg-6 col-md-6 col-sm-6 col-xs-12";
	}else{
...
<div class="tb-product-item <?php echo esc_attr($woo_columns); ?>">
	<?php ( $woocommerce_loop['columns'] == 1) ? wc_get_template('loop/loop-content-one.php') : wc_get_template('loop/loop-content.php'); ?>
</div>