					...
					<div class="tb-start-shop-loop<?php if( $is_full_wid ) echo ' tb-shop-topbar-full'; ?>">
						...
						<div class="tb-view-as">
							<p class="woocommerce-result-count">
								<a href="javascript:void(0);" title="Layout Grid" data-column="3" class="jws_theme_action_grid jws_theme_action_layout jws_theme_action <?php if( ! $is_one_col ){ echo 'active'; }?>"><i class="fa fa-th-large"></i></a>
						...
						<div class="tb-shop-pagination pull-right">
							 ...
							 */
							if($jws_theme_options['jws_theme_archive_show_pagination_shop']){
								echo '<span class="title_page">Page :</span>';
