 ...
 * Breadcrumbs
 *
 * @see jws_theme_woocommerce_breadcrumb()
 */
add_filter( 'woocommerce_breadcrumb_defaults', 'jws_theme_woocommerce_breadcrumb_defaults', 20, 1 );
/**
 * Products Loop
 *
...
// Rename for tags tab
// add_filter( 'woocommerce_product_tabs', 'jws_theme_woo_rename_tabs', 98 );

// change related products args
add_filter( 'woocommerce_output_related_products_args', 'jws_theme_woo_related_products_args' );


add_action( 'woocommerce_product_thumbnails', 'jws_theme_product_featured_video' );

add_filter( 'jws_theme_woocommerce_sortby_page', 'jws_theme_woocommerce_sortby_page', 15, 1);

add_filter( 'jws_theme_woocommerce_no_page', 'jws_theme_woocommerce_no_page', 15, 1);

// change rating output
// add_filter( 'woocommerce_product_get_rating_html', 'jws_theme_woo_get_rating_html' );
