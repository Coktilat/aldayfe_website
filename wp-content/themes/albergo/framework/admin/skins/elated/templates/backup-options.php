	...
	<div class="tab-content">
		<div class="tab-pane fade in active" id="import">
			<div class="eltd-tab-content">
				<h2 class="eltd-page-title"><?php esc_html_e('Backup Options', 'albergo'); ?></h2>
				<form method="post" class="eltd_ajax_form eltd-backup-options-page-holder">
					<div class="eltd-page-form">
						<div class="eltd-page-form-section-holder">
							<h3 class="eltd-page-section-title"><?php esc_html_e('Export/Import Options', 'albergo'); ?></h3>
							<div class="eltd-page-form-section">
								<div class="eltd-field-desc">
									<h4><?php esc_html_e('Export', 'albergo'); ?></h4>
									<p><?php esc_html_e('Copy the code from this field and save it to a textual file to export your options. Save that textual file somewhere so you can later use it to import options if necessary.', 'albergo'); ?></p>
								</div>
							...
							<div class="eltd-page-form-section">
								<div class="eltd-field-desc">
									...
									<p><?php esc_html_e('To import options, just paste the code you previously saved from the "Export" field into this field, and then click the "Import" button.', 'albergo'); ?></p>
								</div>
								<div class="eltd-section-content">
									<div class="container-fluid">
										<div class="row">
							...
							<div class="eltd-page-form-section">
								<div class="eltd-field-desc">
									<button type="button" class="btn btn-primary btn-sm " name="import" id="eltd-import-theme-options-btn"><?php esc_html_e('Import', 'albergo'); ?></button>
							...
							<div class="eltd-page-form-section eltd-import-button-wrapper">
								<div class="alert alert-warning">
									...
									<ul>
										<li><?php esc_html_e('Please note that import process will overide all your existing options.', 'albergo'); ?></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="eltd-page-form-section-holder">
							<h3 class="eltd-page-section-title"><?php esc_html_e('Export/Import Custom Sidebars', 'albergo'); ?></h3>
							<div class="eltd-page-form-section">
								<div class="eltd-field-desc">
									<h4><?php esc_html_e('Export', 'albergo'); ?></h4>
									<p><?php esc_html_e('Copy the code from this field and save it to a textual file to export your options. Save that textual file somewhere so you can later use it to import options if necessary.', 'albergo'); ?></p>
							...
							<div class="eltd-page-form-section">
								<div class="eltd-field-desc">
									<button type="button" class="btn btn-primary btn-sm " name="import" id="eltd-import-custom-sidebars-btn"><?php esc_html_e('Import', 'albergo'); ?></button>
							...
							<div class="eltd-page-form-section eltd-import-button-wrapper">
								<div class="alert alert-warning">
									<strong><?php esc_html_e('Important notes:', 'albergo') ?></strong>
									<ul>
										<li><?php esc_html_e('Please note that import process will override all your existing custom sidebars.', 'albergo'); ?></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="eltd-page-form-section-holder">
							<h3 class="eltd-page-section-title"><?php esc_html_e('Export/Import Widgets', 'albergo'); ?></h3>
							<div class="eltd-page-form-section">
								<div class="eltd-field-desc">
									<h4><?php esc_html_e('Export', 'albergo'); ?></h4>
									<p><?php esc_html_e('Copy the code from this field and save it to a textual file to export your options. Save that textual file somewhere so you can later use it to import options if necessary.', 'albergo'); ?></p>
							...
							<div class="eltd-page-form-section">
								<div class="eltd-field-desc">
									<button type="button" class="btn btn-primary btn-sm " name="import" id="eltd-import-widgets-btn"><?php esc_html_e('Import', 'albergo'); ?></button>
							...
							<div class="eltd-page-form-section eltd-import-button-wrapper">
								<div class="alert alert-warning">
									<strong><?php esc_html_e('Important notes:', 'albergo') ?></strong>
									<ul>
										<li><?php esc_html_e('Please note that import process will override all your existing widgets.', 'albergo'); ?></li>
									</ul>
								</div>
							</div>
						</div>
