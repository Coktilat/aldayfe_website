...
if ( ! function_exists('albergo_elated_contact_form_7_options_map') ) {

	function albergo_elated_contact_form_7_options_map() {

		albergo_elated_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'albergo'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = albergo_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'albergo')
		));

		//Text Typography

		$typography_text_group = albergo_elated_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'albergo'),
			'description'	=> esc_html__('Setup typography for form elements text', 'albergo'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = albergo_elated_add_admin_row(array(
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'albergo'),
		));
		...
		$typography_text_row2 = albergo_elated_add_admin_row(array(
		...
		$typography_text_row3 = albergo_elated_add_admin_row(array(
		...
		$typography_label_group = albergo_elated_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'albergo'),
			'description'	=> esc_html__('Setup typography for form elements label', 'albergo'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = albergo_elated_add_admin_row(array(
		...
		$typography_label_row2 = albergo_elated_add_admin_row(array(
		...
		$background_border_group = albergo_elated_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'albergo'),
			'description'	=> esc_html__('Setup form elements background and border style', 'albergo'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = albergo_elated_add_admin_row(array(
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'albergo')
		));
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'albergo')
		));

		$background_border_row2 = albergo_elated_add_admin_row(array(
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'albergo'),
		));
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'albergo')
		));
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'albergo')
		));

		$background_border_row3 = albergo_elated_add_admin_row(array(
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'albergo'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'albergo'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = albergo_elated_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'albergo'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = albergo_elated_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'albergo'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'albergo'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'albergo'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'albergo'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = albergo_elated_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'albergo'),
			'description'	=> esc_html__('Setup form elements margin', 'albergo'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = albergo_elated_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'albergo'),
			'description'	=> esc_html__('Enter height for textarea form element', 'albergo'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = albergo_elated_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'albergo'),
			'description'	=> esc_html__('Setup button text typography', 'albergo'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = albergo_elated_add_admin_row(array(
		...
		$button_typography_row2 = albergo_elated_add_admin_row(array(
		...
		$button_background_border_group = albergo_elated_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'albergo'),
			'description'	=> esc_html__('Setup button background and border style', 'albergo'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = albergo_elated_add_admin_row(array(
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'albergo')
		));
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'albergo')
		));

		$button_background_border_row2 = albergo_elated_add_admin_row(array(
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'albergo')
		));
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'albergo')
		));

		$button_background_border_row3 = albergo_elated_add_admin_row(array(
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'albergo'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		albergo_elated_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'albergo'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = albergo_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'albergo')
		));
        ...
        $panel_contact_form_style_3 = albergo_elated_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'albergo')
        ));
        ...
        $typography_label_row3 = albergo_elated_add_admin_row(array(
        ...
        $button_typography_row3 = albergo_elated_add_admin_row(array(
	...
	add_action( 'albergo_elated_options_map', 'albergo_elated_contact_form_7_options_map', 20);
}