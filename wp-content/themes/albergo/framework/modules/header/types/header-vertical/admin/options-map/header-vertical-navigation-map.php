...
if ( ! function_exists( 'albergo_elated_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function albergo_elated_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'albergo_elated_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'albergo_elated_header_vertical_navigation_options_map' ) ) {
	function albergo_elated_header_vertical_navigation_options_map() {
		$hide_dep_options = albergo_elated_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = albergo_elated_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'albergo' ),
		...
		$drop_down_group = albergo_elated_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Set a style for dropdown menu', 'albergo' )
			)
		);
		
		$vertical_drop_down_row1 = albergo_elated_add_admin_row(
			array(
		...
		albergo_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'albergo' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		albergo_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'albergo' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		$group_vertical_first_level = albergo_elated_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'albergo' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'albergo' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = albergo_elated_add_admin_row(
			array(
		...
		$row_vertical_first_level_2 = albergo_elated_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = albergo_elated_add_admin_row(
			array(
		...
		$group_vertical_second_level = albergo_elated_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'albergo' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'albergo' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = albergo_elated_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = albergo_elated_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = albergo_elated_add_admin_row(
			array(
		...
		$group_vertical_third_level = albergo_elated_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'albergo' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'albergo' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = albergo_elated_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = albergo_elated_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = albergo_elated_add_admin_row(
			array(
	...
	add_action( 'albergo_elated_additional_header_main_navigation_options_map', 'albergo_elated_header_vertical_navigation_options_map', 10, 1 );
}