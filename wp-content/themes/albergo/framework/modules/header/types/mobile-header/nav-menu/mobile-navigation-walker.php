...
if (!class_exists('AlbergoElatedMobileNavigationWalker')) {
	class AlbergoElatedMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow"><i class="eltd-sub-arrow fa fa-angle-right"></i><i class="icon-arrows-right"></i></span>';
				}
			}
