...
if (!class_exists('AlbergoElatedStickyNavigationWalker')) {
	class AlbergoElatedStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children && $depth == 0) {
					$item_output .= '<i class="eltd-menu-arrow icon-arrows-rightn"></i>';
				}
