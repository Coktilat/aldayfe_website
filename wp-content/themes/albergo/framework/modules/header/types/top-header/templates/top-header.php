<?php
if($show_header_top) {
	do_action('albergo_elated_before_header_top');
	?>
	...
	<div class="eltd-top-bar">
		<?php do_action( 'albergo_elated_after_header_top_html_open' ); ?>
		...
		<?php do_action( 'albergo_elated_before_header_top_html_close' ); ?>
	</div>
	
	<?php do_action('albergo_elated_after_header_top');
}