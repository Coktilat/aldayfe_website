...
if ( ! function_exists( 'albergo_elated_get_hide_dep_for_header_menu_area_options' ) ) {
	function albergo_elated_get_hide_dep_for_header_menu_area_options() {
		$hide_dep_options = apply_filters( 'albergo_elated_header_menu_area_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'albergo_elated_header_menu_area_options_map' ) ) {
	function albergo_elated_header_menu_area_options_map( $panel_header ) {
		$hide_dep_options = albergo_elated_get_hide_dep_for_header_menu_area_options();
		...
		albergo_elated_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set grid background transparency for menu area', 'albergo' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		albergo_elated_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set shadow on grid area', 'albergo' )
			)
		);
		...
		albergo_elated_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set border color for menu area', 'albergo' ),
			)
		);
		...
		albergo_elated_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set background color for menu area', 'albergo' )
			)
		);
		...
		albergo_elated_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set background transparency for menu area', 'albergo' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		albergo_elated_add_admin_field(
			array(
				...
				'default_value' => 'no',
				'label'         => esc_html__( 'Menu Area Area Shadow', 'albergo' ),
		...
		$menu_area_border_container = albergo_elated_add_admin_container(
			array(
				'parent'          => $menu_area_container,
		...
		albergo_elated_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Enter header height', 'albergo' ),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => 'px'
				)
		...
		do_action( 'albergo_elated_header_menu_area_additional_options', $panel_header );
	}
	
	add_action( 'albergo_elated_header_menu_area_options_map', 'albergo_elated_header_menu_area_options_map', 10, 1 );
}