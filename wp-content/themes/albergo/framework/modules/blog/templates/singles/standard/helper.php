...
if( !function_exists('albergo_elated_get_blog_single_holder_classes') ) {
    /**
     * Function that generates blog holder classes for single blog page
     */
    function albergo_elated_get_blog_single_holder_classes($classes) {
    ...
    add_filter( 'albergo_elated_blog_single_holder_classes', 'albergo_elated_get_blog_single_holder_classes' );
}
