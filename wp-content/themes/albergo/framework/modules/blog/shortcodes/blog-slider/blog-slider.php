...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Albergo Blog Slider', 'albergo' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'albergo' )            => 'slider',
							esc_html__( 'Carousel', 'albergo' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'albergo' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		albergo_elated_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
