...
<div class="eltd-title-holder <?php echo esc_attr($holder_classes); ?>" <?php albergo_elated_inline_style($holder_styles); ?> <?php echo albergo_elated_get_inline_attrs($holder_data); ?>>
	...
	<div class="eltd-title-wrapper" <?php albergo_elated_inline_style($wrapper_styles); ?>>
		<div class="eltd-title-inner">
			<div class="eltd-grid">
				<?php if(!empty($title)) { ?>
					<<?php echo esc_attr($title_tag); ?> class="eltd-page-title entry-title" <?php albergo_elated_inline_style($title_styles); ?>>
                        <?php if(!empty($before_title)) { ?>
                            <span class="eltd-before-title-text"><?php echo esc_html($before_title); ?></span>
                        <?php } ?>
