    ...
    <ul class="eltd-pls-inner">
            ...
            <li class="eltd-pls-item">
                <div class="eltd-pls-image">
                    <a itemprop="url" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                        <?php albergo_elated_get_module_template_part('templates/parts/image-simple', 'woocommerce', '', $params); ?>
                    </a>    
                </div>
        ...
        <?php endwhile; else: ?>
            <li class="eltd-pls-messsage">
                <?php albergo_elated_get_module_template_part('templates/parts/no-posts', 'woocommerce', '', $params); ?>
            </li>
        <?php endif;
            wp_reset_postdata();
        ?>
