...
<div class="eltd-plc-holder <?php echo esc_attr( $holder_classes ) ?>">
	<div class="eltd-plc-outer eltd-owl-slider" <?php echo albergo_elated_get_inline_attrs( $holder_data ); ?>>
		<?php if ( $query_result->have_posts() ): while ( $query_result->have_posts() ) : $query_result->the_post(); ?>
			<div class="eltd-plc-item">
				<div class="eltd-plc-image-outer">
					...
					<div class="eltd-plc-text" <?php echo albergo_elated_get_inline_style( $shader_styles ); ?>>
		...
		<?php endwhile;
			...
			albergo_elated_get_module_template_part( 'templates/parts/no-posts', 'woocommerce', '', $params );
		endif;
		wp_reset_postdata();
		?>
	</div>
