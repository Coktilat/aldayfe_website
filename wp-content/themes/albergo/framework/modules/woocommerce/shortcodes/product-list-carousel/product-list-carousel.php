...
class ProductListCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Albergo Product List - Carousel', 'albergo' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'albergo' ),
							'value'       => array(
							...
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'albergo' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'albergo' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'albergo' ),
							'value'       => array_flip( albergo_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'albergo' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'albergo' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'albergo' ),
							'group'       => esc_html__( 'Slider Settings', 'albergo' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'slider_speed_animation',
							'heading'     => esc_html__( 'Slide Animation Duration', 'albergo' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'albergo' ),
							'group'       => esc_html__( 'Slider Settings', 'albergo' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_navigation',
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'albergo' ),
							'value'       => array_flip( albergo_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'albergo' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Navigation Skin', 'albergo' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'albergo' ),
							'value'       => array_flip( albergo_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'albergo' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Skin', 'albergo' ),
							'value'      => array(
								esc_html__( 'Default', 'albergo' ) => 'default',
								esc_html__( 'Light', 'albergo' )   => 'light'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Position', 'albergo' ),
							'value'      => array(
								esc_html__( 'Below Carousel', 'albergo' )  => 'bellow-slider',
								esc_html__( 'Inside Carousel', 'albergo' ) => 'inside-slider'
							),
							'dependency' => array( 'element' => 'slider_pagination', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Slider Settings', 'albergo' )
						),
	...
	public function render( $atts, $content = null ) {
		...
		$html = albergo_elated_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list-carousel', $params['type'], $params, $additional_params );
	...
	private function getCarouselClasses( $params ) {
		...
		$carouselClasses[] = ! empty( $params['slider_navigation_skin'] ) ? 'eltd-plc-nav-' . $params['slider_navigation_skin'] . '-skin' : '';
		$carouselClasses[] = ! empty( $params['slider_pagination_pos'] ) ? 'eltd-plc-pag-' . $params['slider_pagination_pos'] : '';
		$carouselClasses[] = ! empty( $params['slider_pagination_skin'] ) ? 'eltd-plc-pag-' . $params['slider_pagination_skin'] . '-skin' : '';
