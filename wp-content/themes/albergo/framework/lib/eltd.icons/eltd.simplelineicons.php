...
class AlbergoElatedSimpleLineIcons implements iAlbergoElatedIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'albergo'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'albergo'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'albergo'),
            'icon-social-facebook'    => esc_html__('Facebook', 'albergo'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'albergo'),
            'icon-social-github'      => esc_html__('Github', 'albergo'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'albergo'),
            'icon-social-instagram'   => esc_html__('Instagram', 'albergo'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'albergo'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'albergo'),
            'icon-social-reddit'      => esc_html__('Reddit', 'albergo'),
            'icon-social-skype'       => esc_html__('Skype', 'albergo'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'albergo'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'albergo'),
            'icon-social-spotify'     => esc_html__('Spotify', 'albergo'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'albergo'),
            'icon-social-twitter'     => esc_html__('Twitter', 'albergo'),
            'icon-social-youtube'     => esc_html__('Youtube', 'albergo')
        );
    }
