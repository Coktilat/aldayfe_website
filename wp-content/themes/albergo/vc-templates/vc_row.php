...
if ( $row_content_width !== 'grid' ) {
	...
	if (!empty($parallax_background_image)) {
		...
		$css_classes[] = 'eltd-parallax-row-holder';
	...
	if (!empty($parallax_background_image)) {
		...
		$grid_row_class[] = 'eltd-parallax-row-holder';
...
if($row_content_width === 'grid'){
	$eltd_row_wrapper_start .= '<div class="eltd-row-grid-section-wrapper '.esc_attr($grid_row_classes).'" '.esc_attr($grid_row_datas).' ' . albergo_elated_get_inline_style( $eltd_grid_row_styles ) . '><div class="eltd-row-grid-section">';
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . albergo_elated_get_inline_style( $eltd_vc_row_styles ) . '>';
