            ...
            <div class="content-wrap">
                <section id="tabs-1" class="content-current">
                    <div class="wcf-control-section">
                        <a href="#" id="woocs_add_currency" class="dashicons-before dashicons-plus"><?php _e("Add Currency", 'woocommerce-currency-switcher') ?></a><br />
...
function woocs_print_currency($_this, $currency) {
    ...
    <li>
        ...
        &nbsp;<a href="#" class="woocs_del_currency help_tip" data-tip="<?php _e("remove", 'woocommerce-currency-switcher'); ?>" style="vertical-align: middle;"><span class="woocs-btn-delete dashicons-before dashicons-dismiss"></span></a>
