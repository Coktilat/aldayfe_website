    ...
    public function import_widgets( $data ) {
      ...
      foreach ( $data as $sidebar_id => $widgets ) {
        ...
        foreach ( $widgets as $widget_instance_id => $widget ) {
          ...
          $orion_widget_title = 'No Title';

          if (is_object($widget) && isset($widget->title)) {
            $orion_widget_title = $widget->title;
          } else if (is_array($widget) && isset($widget['title'])) {
            $orion_widget_title = $widget['title'];
          } 
          $results[$sidebar_id]['widgets'][$widget_instance_id]['title'] = $orion_widget_title;
